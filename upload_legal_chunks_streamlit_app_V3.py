...
class LegalDocumentParser:
    ...
    def _extract_tags(self, text: str) -> List[str]:
        ...
        legal_tags = {
            ...
            "indemnity", "negligence", "tort", "remedy", "injunction","crime","familly","marriage","human rights"
        }
        ...
        legal_refs = re.findall(r'\b(?:Article|Section|Clause|Paragraph)\s+\d+\b', text, re.IGNORECASE)
        tags.extend([ref.lower() for ref in legal_refs[:3]])  # Limit to 3 references
        
        # Extract capitalized legal terms
